...
:root {
  ...
  --color-accent-border:rgba(34,211,238,0.2);
  --color-indigo:       #818cf8;
  --color-text-primary:   #ffffff;
  --color-text-secondary: rgba(255,255,255,0.38);
...
/* ─── Selection ──────────────────────────────────────────────── */
::-moz-selection { background: rgba(34,211,238,0.2); color: #fff; }
...
a, button { transition: color var(--transition-fast), background var(--transition-fast), border-color var(--transition-fast), opacity var(--transition-fast); }
...
/* ─── Pulse keyframe (for animated dots) ────────────────────── */
@keyframes pulse-dot {
  0%, 100% { opacity: 1; }
  50%       { opacity: 0.4; }
}

/* ─── Generic pulse for research loading dots ─────────────────── */
@keyframes pulse {
...
/* ─── Mobile shell: bottom navigation spacing ────────────────── */
/* Pages inside AppShell get padding-bottom equal to bottom nav */
.mobile-page-content {
...
/* ─── Input font size on mobile prevents zoom ─────────────────── */
@media (max-width: 767px) {
  input, textarea, select {
