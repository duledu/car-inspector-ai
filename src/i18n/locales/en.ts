...
const en = {
  ...
  'inspection.prepReportDisclaimer':  'Results are generated from the available data and are meant to support your evaluation of the vehicle. For maximum confidence, an additional professional inspection before purchase is recommended.',
  ...
  // ─── Photo coverage tiers (0–2 insufficient / 3–7 partial / 8 complete) ───────
  'inspection.lowCoverageWarning.title':          'Limited photo coverage',
  'inspection.lowCoverageWarning.body':           'You have added fewer than 3 vehicle photos.\n\nWithout enough photos, Used Cars Doctor has less visual information to analyze, so the final assessment may be less accurate or may miss visible damage.\n\nYou can continue without adding more photos, but the report should be treated with additional caution.\n\nDo you want to continue?',
  'inspection.lowCoverageWarning.addMore':        'Add More Photos',
  'inspection.lowCoverageWarning.continueAnyway': 'Continue Anyway',
  'inspection.insufficientCoverageNotice':        'Insufficient photo coverage — {{count}} of 8 photos captured. Add more before continuing for a reliable assessment.',
  'inspection.partialCoverageNotice':             'Partial photo coverage — adding all recommended angles can improve the assessment.',
  ...
  'report.negotiationLeverageLabel': 'Estimated negotiation leverage',
  'report.negotiationLeverageIntro': 'Use these findings to discuss a fair reduction with the seller. The estimate is based on inspection risk signals, not a guaranteed market valuation.',
  'report.negotiationAskingPrice':   'Asking price',
  'report.negotiationSuggestedReduction': 'Suggested price reduction',
  'report.negotiationMinimumReduction':   'Minimum reduction to discuss',
  'report.negotiationUseFindings':   'Use findings to negotiate',
  'report.negotiationAdvisoryOnly':  'Advisory only',
  'report.negotiationSupportedBy':   'Supported by these findings',
  'report.negotiationDisclaimer':    'This is advisory negotiation guidance. It is not guaranteed savings, a formal appraisal, or proof of repair cost. Use it as a structured talking point and verify issues before purchase.',
  ...
  'report.noPhotosAnalysis.title':   'Photo analysis not performed',
  'report.noPhotosAnalysis.body':    'No photos were added, so AI photo analysis was not performed for this vehicle. This is not a pass or a clean result — it means no visual inspection occurred. Add photos to the inspection for an assessment.',
  'report.photoCoverage.notPerformed.title': 'Photo analysis not performed',
  'report.photoCoverage.notPerformed.body':  'No photos were analyzed for this vehicle. This is not a pass or a clean result.',
  'report.photoCoverage.limited.title':      'Limited photo analysis',
  'report.photoCoverage.limited.body':       'Only {{count}} photo(s) were analyzed. The assessment may be incomplete or inaccurate because photo coverage was insufficient.',
  'report.photoCoverage.partial.title':      'Partial photo coverage',
  'report.photoCoverage.partial.body':       'Additional recommended angles could improve confidence in this result.',
  'report.photoCoverage.full.title':         'Full photo coverage',
