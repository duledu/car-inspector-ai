...
const marketingLanguageDefaults: LanguageDefaults<MarketingCampaignLocalizedFields> = {
  ...
  bg: {
    ...
    previewText: 'Открийте скритите проблеми, преди да вземете решение.',
    headline: 'Проверете преди да купите.',
    introParagraph: 'Проверете VIN историята, снимките и сигналите за измама, преди да се срещнете с продавача.',
    ctaLabel: 'Започнете безплатен преглед',
    value1: 'Проверка на VIN и история на катастрофи',
    value2: 'AI анализ на снимки за скрити щети',
...
const announcementBodyDefaults: LanguageDefaults<AppAnnouncementLocalizedFields> = {
  ...
  bg: {
    ...
    card2Description: 'По-умно откриване на предупредителни сигнали във всички обяви.',
    card3Title: 'По-богати доклади',
    card3Description: 'Повече детайли и по-ясно форматиране във всеки доклад.',
    card4Title: 'По-бърза обработка',
    card4Description: 'Пълните резултати от прегледа се доставят за секунди.',
    signatureLine: '— Екипът на Used Cars Doctor',
  },
}
